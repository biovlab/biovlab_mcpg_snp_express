...
par(cex.main=1)
heatmap3(data,margins=c(bottom_margin,5),Rowv=TRUE,ColSideColors=ColSideColors,showRowDendro=FALSE,scale="none",cexRow=0.7, cexCol=1.2,main=title)
legend("topright", legend=colside_label, fill=colside_color, border=FALSE, bty="n", y.intersp=1, cex=0.8)
dev.off()
