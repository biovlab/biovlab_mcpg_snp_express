...
########################################
	...
	# create heatmap
	$R_DIR/Rscript $bin_dir/make_heatmap3_ver2.r "$viz_result_dir/ME_matrix.kw.txt.sorted.top10" `my_join "," ${methyl_list[@]}` "Class" `my_join "," ${type_list[@]}` "$viz_result_dir/DMR_TOP10_heatmap.png" "Top_10_DMRs_by_Kruscal_Wallis"
