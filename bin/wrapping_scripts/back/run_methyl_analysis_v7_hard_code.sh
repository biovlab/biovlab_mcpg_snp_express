...
type_kind=("BaA" "BaB" "Lu") #(${me_type_kind[@]})
type_list=("BaA" "BaA" "BaB" "BaB" "Lu" "Lu") #${me_type_list[@]})
data_dir="/usr/local/apache2/htdocs/airavata-php-gateway/app/storage/temp/"
sample_fq1_list=($data_dir/HCC70_test_1.fq $data_dir/HCC1954_test_1.fq $data_dir/BT549_test_1.fq $data_dir/mDAmB_231_test_1.fq $data_dir/AU565_test_1.fq $data_dir/HCC202_test_1.fq)
sample_fq2_list=($data_dir/HCC70_test_2.fq $data_dir/HCC1954_test_2.fq $data_dir/BT549_test_2.fq $data_dir/mDAmB_231_test_2.fq $data_dir/AU565_test_2.fq $data_dir/HCC202_test_2.fq)


sample_format=3	# 0: MBD-Seq / MeDIP-Seq, 1: "Infinium 27k", 2:"Infinium 450k", 3:"BS-seq"
pair_single_flag="pair"
...
if [ "$sample_format" -eq "3" ]; then # BS
	...
	for (( i=0; i<${#mbd_r1_list[@]}; i++ )); do
		bash $bin_dir/mbd_ver2.sh ${mbd_r1_list[$i]} ${mbd_r2_list[$i]} $pair_single_flag $mbd_result_dir		# align by STAR, so no need to be parallelization.
	done
