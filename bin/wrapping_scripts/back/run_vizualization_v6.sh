...
########################################
	...
	/home/airavata/packages/R-3.2.3/bin/Rscript $bin_dir/barplot_ver2.r $viz_result_dir/DMR_region_stat_matrix.txt $viz_result_dir/DMR_region_stat_barplot.png "region"
	/home/airavata/packages/R-3.2.3/bin/Rscript $bin_dir/barplot_ver2.r $viz_result_dir/DMR_cpgi_stat_matrix.txt $viz_result_dir/DMR_cpgi_stat_barplot.png "cgi"
...
for range in "genebody" "cpgIsland" "exon"; do 
	...
	# line plot
	/home/airavata/packages/R-3.2.3/bin/Rscript $bin_dir/plot.r $viz_result_dir/GDSNP_$range"_matrix4plot_merged" $viz_result_dir/GDSNP_$range"_matrix4plot_merged.png" 
	...
	for (( k=0; k<${#type_kind[@]}; k++ )); do 
		...
		/home/airavata/packages/R-3.2.3/bin/Rscript $bin_dir/plot.r $viz_result_dir/SNP_$range"_MAT_"${type_kind[$k]} $viz_result_dir/SNP_$range"_"${type_kind[$k]}".png"
	done

	# merge all stat files
	paste $viz_result_dir/prefix_percentage_ids ${paste_list_all[@]} > $viz_result_dir/SNP_$range"_MAT_all"

	/home/airavata/packages/R-3.2.3/bin/Rscript $bin_dir/plot.r $viz_result_dir/SNP_$range"_matrix4plot_all" $viz_result_dir/SNP_$range"_all.png"
