...
########################################
	...
	Rscript $bin_dir/barplot_ver2.r $viz_result_dir/DMR_region_stat_matrix.txt $viz_result_dir/DMR_region_stat_barplot.png "region"
	Rscript $bin_dir/barplot_ver2.r $viz_result_dir/DMR_cpgi_stat_matrix.txt $viz_result_dir/DMR_cpgi_stat_barplot.png "cgi"
