...
final_result_url_ge=$final_result_url/gene-expression
...
cp $circos_dir/*.png $final_result_dir_inte
...
########################################
	...
	# copy to web accessible directory
	cp $viz_result_dir/GDMR_by_kw.bb $final_result_dir_me
...
########################################
	...
	cp $viz_result_dir/DMR_region_stat_barplot.png $viz_result_dir/DMR_cpgi_stat_barplot.png $final_result_dir_me
...
# GDSNP all :  bed w/ label -> bb
	...
	cp $viz_result_dir/GDSNP_sorted.bb $final_result_dir_mu
...
# GDSNP per sample : boxplot
	...
	cp $vis_result_dir/GDSNP_boxplot_genomic.png $viz_result_dir/GDSNP_boxplot_cpgi.png $final_result_dir_mu
...
cp *"_mu_rate.png" $final_result_dir_inte
