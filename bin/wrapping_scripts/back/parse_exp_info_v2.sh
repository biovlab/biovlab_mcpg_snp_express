...
for (( i=0; i<$total_num_tuple; i++ )); do
	...
	####################################################
		...
		elif [ "$sample_format" == "Infinium 27k" ] || [ "$sample_format" == "Infinium 450k" ]; then									# Infinium 27/450k
			# TODO : set for Infinium
			me_is_array=1; me_single_pair="single"; me_array_list+=($work_file)
		fi
...
echo "[INFO] Is array?: $me_is_array"
