...
# 2.1 Microarray (.CELL)
	...
	for (( i=0; i<${#cel_list[@]}; i=i+1 )); do
		...
		$bin_dir"/"bedGraphToBigWig $cel_result_dir"/"$exp_file1_filename_only".gene_symbol_exp.sorted.cut.bed" $REF_HUMAN_CHR_SIZE $cel_result_dir"/"$exp_file1_filename_only".bw"
	done
