...
mu_result_dir=""
mu_result_dir="/usr/local/apache2/htdocs/biovlab_mcpg_snp_express/result/snp/from_mbd/"

if [ $mu_type -eq 2 ]; then # Human Map
	mu_result_dir=""
elif [ $mu_type -eq 1 ]; then # RNA-seq
	mu_result_dir=$result_dir"/mu/rna_seq/2pass/"
elif [ $mu_type -eq 0 ]; then # DNA-seq
else
	mu_result_dir=""
fi
